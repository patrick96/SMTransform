...
type BaseParserType<'input, I> =
	BaseParser<'input,SMTLIBv2ParserExt, I, SMTLIBv2ParserContextType , dyn SMTLIBv2Listener<'input> + 'input >;
...
impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> ParserRecog<'input, BaseParserType<'input,I>> for SMTLIBv2ParserExt{}

impl<'input,I: TokenStream<'input, TF = LocalTokenFactory<'input> > + TidAble<'input>> Actions<'input, BaseParserType<'input,I>> for SMTLIBv2ParserExt{
	fn get_grammar_file_name(&self) -> & str{ "SMTLIBv2.g4"}
...
impl<'input> StartContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StartContextAll<'input>> {
		Rc::new(
...
pub trait StartContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<StartContextExt<'input>>{

fn script(&self) -> Option<Rc<ScriptContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token EOF
/// Returns `None` if there is no child corresponding to token EOF
fn EOF(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
impl<'input> CustomRuleContext<'input> for ResponseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_response }
...
impl<'input> ResponseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ResponseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,ResponseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait ResponseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<ResponseContextExt<'input>>{

fn general_response(&self) -> Option<Rc<General_responseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token EOF
/// Returns `None` if there is no child corresponding to token EOF
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ResponseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type GeneralReservedWordContext<'input> = BaseParserRuleContext<'input,GeneralReservedWordContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for GeneralReservedWordContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for GeneralReservedWordContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_generalReservedWord }
...
impl<'input> GeneralReservedWordContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<GeneralReservedWordContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,GeneralReservedWordContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait GeneralReservedWordContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<GeneralReservedWordContextExt<'input>>{
...
fn GRW_Exclamation(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn GRW_Underscore(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn GRW_As(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn GRW_Binary(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn GRW_Decimal(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn GRW_Exists(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn GRW_Hexadecimal(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn GRW_Forall(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn GRW_Let(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn GRW_Match(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn GRW_Numeral(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn GRW_Par(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn GRW_String(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn generalReservedWord(&mut self,)
	-> Result<Rc<GeneralReservedWordContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = GeneralReservedWordContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 4, RULE_generalReservedWord);
		...
		let result: Result<(), ANTLRError> = try {
			...
			if { !(((((_la - 53)) & !0x3f) == 0 && ((1usize << (_la - 53)) & ((1usize << (GRW_Exclamation - 53)) | (1usize << (GRW_Underscore - 53)) | (1usize << (GRW_As - 53)) | (1usize << (GRW_Binary - 53)) | (1usize << (GRW_Decimal - 53)) | (1usize << (GRW_Exists - 53)) | (1usize << (GRW_Hexadecimal - 53)) | (1usize << (GRW_Forall - 53)) | (1usize << (GRW_Let - 53)) | (1usize << (GRW_Match - 53)) | (1usize << (GRW_Numeral - 53)) | (1usize << (GRW_Par - 53)) | (1usize << (GRW_String - 53)))) != 0)) } {
...
pub type SimpleSymbolContext<'input> = BaseParserRuleContext<'input,SimpleSymbolContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for SimpleSymbolContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_simpleSymbol }
...
impl<'input> SimpleSymbolContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SimpleSymbolContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,SimpleSymbolContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait SimpleSymbolContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<SimpleSymbolContextExt<'input>>{

fn predefSymbol(&self) -> Option<Rc<PredefSymbolContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
fn UndefinedSymbol(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn simpleSymbol(&mut self,)
	-> Result<Rc<SimpleSymbolContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = SimpleSymbolContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 6, RULE_simpleSymbol);
			...
			match recog.base.input.la(1) {
			 ...
			 UndefinedSymbol
				=> {
					...
					recog.base.match_token(UndefinedSymbol,&mut recog.err_handler)?;
...
pub type QuotedSymbolContext<'input> = BaseParserRuleContext<'input,QuotedSymbolContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for QuotedSymbolContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_quotedSymbol }
...
impl<'input> QuotedSymbolContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<QuotedSymbolContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,QuotedSymbolContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait QuotedSymbolContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<QuotedSymbolContextExt<'input>>{
...
fn QuotedSymbol(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn quotedSymbol(&mut self,)
	-> Result<Rc<QuotedSymbolContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = QuotedSymbolContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 8, RULE_quotedSymbol);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(QuotedSymbol,&mut recog.err_handler)?;
...
pub type PredefSymbolContext<'input> = BaseParserRuleContext<'input,PredefSymbolContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for PredefSymbolContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_predefSymbol }
...
impl<'input> PredefSymbolContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<PredefSymbolContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,PredefSymbolContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait PredefSymbolContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<PredefSymbolContextExt<'input>>{
...
fn PS_Not(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PS_Bool(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PS_ContinuedExecution(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PS_Error(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PS_False(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PS_ImmediateExit(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PS_Incomplete(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PS_Logic(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PS_Memout(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PS_Sat(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PS_Success(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PS_Theory(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PS_True(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PS_Unknown(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PS_Unsupported(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PS_Unsat(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn predefSymbol(&mut self,)
	-> Result<Rc<PredefSymbolContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = PredefSymbolContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 10, RULE_predefSymbol);
		...
		let result: Result<(), ANTLRError> = try {
			...
			_la = recog.base.input.la(1);
			if { !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << PS_Not) | (1usize << PS_Bool) | (1usize << PS_ContinuedExecution) | (1usize << PS_Error) | (1usize << PS_False) | (1usize << PS_ImmediateExit) | (1usize << PS_Incomplete) | (1usize << PS_Logic) | (1usize << PS_Memout) | (1usize << PS_Sat) | (1usize << PS_Success) | (1usize << PS_Theory) | (1usize << PS_True) | (1usize << PS_Unknown) | (1usize << PS_Unsupported) | (1usize << PS_Unsat))) != 0)) } {
				recog.err_handler.recover_inline(&mut recog.base)?;
...
pub type PredefKeywordContext<'input> = BaseParserRuleContext<'input,PredefKeywordContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for PredefKeywordContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_predefKeyword }
...
impl<'input> PredefKeywordContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<PredefKeywordContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,PredefKeywordContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait PredefKeywordContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<PredefKeywordContextExt<'input>>{
...
fn PK_AllStatistics(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_AssertionStackLevels(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Authors(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Category(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Chainable(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Definition(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_DiagnosticOutputChannel(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_ErrorBehaviour(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Extension(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Funs(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_FunsDescription(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_GlobalDeclarations(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_InteractiveMode(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Language(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_LeftAssoc(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_License(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Named(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Name(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Notes(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Pattern(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_PrintSuccess(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_ProduceAssertions(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_ProduceAssignments(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_ProduceModels(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_ProduceProofs(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_ProduceUnsatAssumptions(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_ProduceUnsatCores(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_RandomSeed(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_ReasonUnknown(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_RegularOutputChannel(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_ReproducibleResourceLimit(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_RightAssoc(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_SmtLibVersion(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Sorts(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_SortsDescription(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Source(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Status(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Theories(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Values(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Verbosity(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn PK_Version(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn predefKeyword(&mut self,)
	-> Result<Rc<PredefKeywordContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = PredefKeywordContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 12, RULE_predefKeyword);
		...
		let result: Result<(), ANTLRError> = try {
			...
			_la = recog.base.input.la(1);
			if { !(((((_la - 71)) & !0x3f) == 0 && ((1usize << (_la - 71)) & ((1usize << (PK_AllStatistics - 71)) | (1usize << (PK_AssertionStackLevels - 71)) | (1usize << (PK_Authors - 71)) | (1usize << (PK_Category - 71)) | (1usize << (PK_Chainable - 71)) | (1usize << (PK_Definition - 71)) | (1usize << (PK_DiagnosticOutputChannel - 71)) | (1usize << (PK_ErrorBehaviour - 71)) | (1usize << (PK_Extension - 71)) | (1usize << (PK_Funs - 71)) | (1usize << (PK_FunsDescription - 71)) | (1usize << (PK_GlobalDeclarations - 71)) | (1usize << (PK_InteractiveMode - 71)) | (1usize << (PK_Language - 71)) | (1usize << (PK_LeftAssoc - 71)) | (1usize << (PK_License - 71)) | (1usize << (PK_Named - 71)) | (1usize << (PK_Name - 71)) | (1usize << (PK_Notes - 71)) | (1usize << (PK_Pattern - 71)) | (1usize << (PK_PrintSuccess - 71)) | (1usize << (PK_ProduceAssertions - 71)) | (1usize << (PK_ProduceAssignments - 71)) | (1usize << (PK_ProduceModels - 71)) | (1usize << (PK_ProduceProofs - 71)) | (1usize << (PK_ProduceUnsatAssumptions - 71)) | (1usize << (PK_ProduceUnsatCores - 71)) | (1usize << (PK_RandomSeed - 71)) | (1usize << (PK_ReasonUnknown - 71)) | (1usize << (PK_RegularOutputChannel - 71)) | (1usize << (PK_ReproducibleResourceLimit - 71)) | (1usize << (PK_RightAssoc - 71)) | (1usize << (PK_SmtLibVersion - 71)) | (1usize << (PK_Sorts - 71)) | (1usize << (PK_SortsDescription - 71)) | (1usize << (PK_Source - 71)) | (1usize << (PK_Status - 71)) | (1usize << (PK_Theories - 71)) | (1usize << (PK_Values - 71)) | (1usize << (PK_Verbosity - 71)) | (1usize << (PK_Version - 71)))) != 0)) } {
				recog.err_handler.recover_inline(&mut recog.base)?;
...
impl<'input> SymbolContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SymbolContextAll<'input>> {
		Rc::new(
...
pub trait SymbolContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<SymbolContextExt<'input>>{

fn simpleSymbol(&self) -> Option<Rc<SimpleSymbolContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn quotedSymbol(&self) -> Option<Rc<QuotedSymbolContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
	...
	-> Result<Rc<SymbolContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = try {
			...
			match recog.base.input.la(1) {
			 PS_Not | PS_Bool | PS_ContinuedExecution | PS_Error | PS_False | PS_ImmediateExit |
			 PS_Incomplete | PS_Logic | PS_Memout | PS_Sat | PS_Success | PS_Theory |
			 PS_True | PS_Unknown | PS_Unsupported | PS_Unsat | UndefinedSymbol
				=> {
					//recog.base.enter_outer_alt(_localctx.clone(), 1);
					recog.base.enter_outer_alt(None, 1);
					{
...
impl<'input> CustomRuleContext<'input> for NumeralContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_numeral }
...
impl<'input> NumeralContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<NumeralContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,NumeralContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait NumeralContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<NumeralContextExt<'input>>{
...
fn Numeral(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn numeral(&mut self,)
	-> Result<Rc<NumeralContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> CustomRuleContext<'input> for DecimalContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_decimal }
...
impl<'input> DecimalContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<DecimalContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,DecimalContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait DecimalContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<DecimalContextExt<'input>>{
...
fn Decimal(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<DecimalContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> CustomRuleContext<'input> for HexadecimalContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_hexadecimal }
...
impl<'input> HexadecimalContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<HexadecimalContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,HexadecimalContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait HexadecimalContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<HexadecimalContextExt<'input>>{
...
fn HexDecimal(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn hexadecimal(&mut self,)
	-> Result<Rc<HexadecimalContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = HexadecimalContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 20, RULE_hexadecimal);
...
impl<'input> CustomRuleContext<'input> for BinaryContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_binary }
...
impl<'input> BinaryContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<BinaryContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,BinaryContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait BinaryContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<BinaryContextExt<'input>>{
...
fn Binary(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<BinaryContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> StringContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<StringContextAll<'input>> {
		Rc::new(
...
pub trait StringContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<StringContextExt<'input>>{

/// Retrieves first TerminalNode corresponding to token String
/// Returns `None` if there is no child corresponding to token String
fn String(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
impl<'input> KeywordContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<KeywordContextAll<'input>> {
		Rc::new(
...
pub trait KeywordContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<KeywordContextExt<'input>>{

fn predefKeyword(&self) -> Option<Rc<PredefKeywordContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token Colon
/// Returns `None` if there is no child corresponding to token Colon
fn Colon(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
pub type Spec_constantContext<'input> = BaseParserRuleContext<'input,Spec_constantContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Spec_constantContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_spec_constant }
...
impl<'input> Spec_constantContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Spec_constantContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Spec_constantContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Spec_constantContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Spec_constantContextExt<'input>>{

fn numeral(&self) -> Option<Rc<NumeralContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn decimal(&self) -> Option<Rc<DecimalContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn hexadecimal(&self) -> Option<Rc<HexadecimalContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn binary(&self) -> Option<Rc<BinaryContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn spec_constant(&mut self,)
	-> Result<Rc<Spec_constantContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Spec_constantContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 28, RULE_spec_constant);
...
impl<'input> CustomRuleContext<'input> for S_exprContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_s_expr }
...
impl<'input> S_exprContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<S_exprContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,S_exprContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait S_exprContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<S_exprContextExt<'input>>{

fn spec_constant(&self) -> Option<Rc<Spec_constantContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
fn ParOpen(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn ParClose(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
	self.get_token(ParClose, 0)
}
fn s_expr_all(&self) ->  Vec<Rc<S_exprContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn s_expr(&self, i: usize) -> Option<Rc<S_exprContextAll<'input>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<S_exprContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		...
		let result: Result<(), ANTLRError> = try {
			...
			match recog.base.input.la(1) {
			 ...
			 Colon | PK_AllStatistics | PK_AssertionStackLevels | PK_Authors | PK_Category |
			 PK_Chainable | PK_Definition | PK_DiagnosticOutputChannel | PK_ErrorBehaviour |
			 PK_Extension | PK_Funs | PK_FunsDescription | PK_GlobalDeclarations |
			 PK_InteractiveMode | PK_Language | PK_LeftAssoc | PK_License | PK_Named |
			 PK_Name | PK_Notes | PK_Pattern | PK_PrintSuccess | PK_ProduceAssertions |
			 ...
			 ParOpen
				=> {
					...
					recog.err_handler.sync(&mut recog.base)?;
					_la = recog.base.input.la(1);
					while (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << ParOpen) | (1usize << String) | (1usize << QuotedSymbol) | (1usize << PS_Not) | (1usize << PS_Bool) | (1usize << PS_ContinuedExecution) | (1usize << PS_Error) | (1usize << PS_False) | (1usize << PS_ImmediateExit) | (1usize << PS_Incomplete) | (1usize << PS_Logic) | (1usize << PS_Memout) | (1usize << PS_Sat) | (1usize << PS_Success) | (1usize << PS_Theory) | (1usize << PS_True) | (1usize << PS_Unknown) | (1usize << PS_Unsupported) | (1usize << PS_Unsat))) != 0) || ((((_la - 66)) & !0x3f) == 0 && ((1usize << (_la - 66)) & ((1usize << (Numeral - 66)) | (1usize << (Binary - 66)) | (1usize << (HexDecimal - 66)) | (1usize << (Decimal - 66)) | (1usize << (Colon - 66)) | (1usize << (PK_AllStatistics - 66)) | (1usize << (PK_AssertionStackLevels - 66)) | (1usize << (PK_Authors - 66)) | (1usize << (PK_Category - 66)) | (1usize << (PK_Chainable - 66)) | (1usize << (PK_Definition - 66)) | (1usize << (PK_DiagnosticOutputChannel - 66)) | (1usize << (PK_ErrorBehaviour - 66)) | (1usize << (PK_Extension - 66)) | (1usize << (PK_Funs - 66)) | (1usize << (PK_FunsDescription - 66)) | (1usize << (PK_GlobalDeclarations - 66)) | (1usize << (PK_InteractiveMode - 66)) | (1usize << (PK_Language - 66)) | (1usize << (PK_LeftAssoc - 66)) | (1usize << (PK_License - 66)) | (1usize << (PK_Named - 66)) | (1usize << (PK_Name - 66)) | (1usize << (PK_Notes - 66)) | (1usize << (PK_Pattern - 66)) | (1usize << (PK_PrintSuccess - 66)) | (1usize << (PK_ProduceAssertions - 66)) | (1usize << (PK_ProduceAssignments - 66)) | (1usize << (PK_ProduceModels - 66)) | (1usize << (PK_ProduceProofs - 66)) | (1usize << (PK_ProduceUnsatAssumptions - 66)) | (1usize << (PK_ProduceUnsatCores - 66)) | (1usize << (PK_RandomSeed - 66)) | (1usize << (PK_ReasonUnknown - 66)) | (1usize << (PK_RegularOutputChannel - 66)) | (1usize << (PK_ReproducibleResourceLimit - 66)) | (1usize << (PK_RightAssoc - 66)) | (1usize << (PK_SmtLibVersion - 66)) | (1usize << (PK_Sorts - 66)) | (1usize << (PK_SortsDescription - 66)) | (1usize << (PK_Source - 66)) | (1usize << (PK_Status - 66)) | (1usize << (PK_Theories - 66)) | (1usize << (PK_Values - 66)) | (1usize << (PK_Verbosity - 66)) | (1usize << (PK_Version - 66)) | (1usize << (UndefinedSymbol - 66)))) != 0) {
						{
						{
						/*InvokeRule s_expr*/
...
impl<'input> CustomRuleContext<'input> for IndexContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_index }
	//fn type_rule_index() -> usize where Self: Sized { RULE_index }
}
antlr_rust::type_id!{IndexContextExt<'a>}

impl<'input> IndexContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<IndexContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,IndexContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait IndexContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<IndexContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<IndexContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> IdentifierContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<IdentifierContextAll<'input>> {
		Rc::new(
...
pub trait IdentifierContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<IdentifierContextExt<'input>>{
...
fn index_all(&self) ->  Vec<Rc<IndexContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn index(&self, i: usize) -> Option<Rc<IndexContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<IdentifierContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 34, RULE_identifier);
			...
			match recog.base.input.la(1) {
			 ...
			 ParOpen
				=> {
					...
					recog.base.match_token(GRW_Underscore,&mut recog.err_handler)?;
					...
					loop {
						...
						recog.err_handler.sync(&mut recog.base)?;
						_la = recog.base.input.la(1);
						if !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << QuotedSymbol) | (1usize << PS_Not) | (1usize << PS_Bool) | (1usize << PS_ContinuedExecution) | (1usize << PS_Error) | (1usize << PS_False) | (1usize << PS_ImmediateExit) | (1usize << PS_Incomplete) | (1usize << PS_Logic) | (1usize << PS_Memout) | (1usize << PS_Sat) | (1usize << PS_Success) | (1usize << PS_Theory) | (1usize << PS_True) | (1usize << PS_Unknown) | (1usize << PS_Unsupported) | (1usize << PS_Unsat))) != 0) || _la==Numeral || _la==UndefinedSymbol) {break}
					}
...
pub type Attribute_valueContext<'input> = BaseParserRuleContext<'input,Attribute_valueContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Attribute_valueContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_attribute_value }
...
impl<'input> Attribute_valueContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Attribute_valueContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Attribute_valueContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Attribute_valueContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Attribute_valueContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn attribute_value(&mut self,)
	-> Result<Rc<Attribute_valueContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Attribute_valueContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 36, RULE_attribute_value);
...
impl<'input> AttributeContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<AttributeContextAll<'input>> {
		Rc::new(
...
pub trait AttributeContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<AttributeContextExt<'input>>{

fn keyword(&self) -> Option<Rc<KeywordContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn attribute_value(&self) -> Option<Rc<Attribute_valueContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
impl<'input> SortContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<SortContextAll<'input>> {
		Rc::new(
...
pub trait SortContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<SortContextExt<'input>>{
...
fn sort_all(&self) ->  Vec<Rc<SortContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn sort(&self, i: usize) -> Option<Rc<SortContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
			...
			,
				2 =>{
					...
					loop {
						...
						recog.err_handler.sync(&mut recog.base)?;
						_la = recog.base.input.la(1);
						if !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << ParOpen) | (1usize << QuotedSymbol) | (1usize << PS_Not) | (1usize << PS_Bool) | (1usize << PS_ContinuedExecution) | (1usize << PS_Error) | (1usize << PS_False) | (1usize << PS_ImmediateExit) | (1usize << PS_Incomplete) | (1usize << PS_Logic) | (1usize << PS_Memout) | (1usize << PS_Sat) | (1usize << PS_Success) | (1usize << PS_Theory) | (1usize << PS_True) | (1usize << PS_Unknown) | (1usize << PS_Unsupported) | (1usize << PS_Unsat))) != 0) || _la==UndefinedSymbol) {break}
					}
...
pub type Qual_identifierContext<'input> = BaseParserRuleContext<'input,Qual_identifierContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Qual_identifierContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_qual_identifier }
...
impl<'input> Qual_identifierContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Qual_identifierContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Qual_identifierContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Qual_identifierContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Qual_identifierContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn qual_identifier(&mut self,)
	-> Result<Rc<Qual_identifierContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Qual_identifierContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 42, RULE_qual_identifier);
...
impl<'input> CustomRuleContext<'input> for Var_bindingContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_var_binding }
...
impl<'input> Var_bindingContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Var_bindingContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Var_bindingContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Var_bindingContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Var_bindingContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn var_binding(&mut self,)
	-> Result<Rc<Var_bindingContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Var_bindingContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 44, RULE_var_binding);
...
impl<'input> CustomRuleContext<'input> for Sorted_varContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_sorted_var }
...
impl<'input> Sorted_varContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Sorted_varContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Sorted_varContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Sorted_varContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Sorted_varContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn sorted_var(&mut self,)
	-> Result<Rc<Sorted_varContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Sorted_varContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 46, RULE_sorted_var);
...
impl<'input> PatternContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<PatternContextAll<'input>> {
		Rc::new(
...
pub trait PatternContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<PatternContextExt<'input>>{

fn symbol_all(&self) ->  Vec<Rc<SymbolContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn symbol(&self, i: usize) -> Option<Rc<SymbolContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token ParOpen
/// Returns `None` if there is no child corresponding to token ParOpen
...
impl<'input> CustomRuleContext<'input> for Match_caseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_match_case }
...
impl<'input> Match_caseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Match_caseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Match_caseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Match_caseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Match_caseContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn match_case(&mut self,)
	-> Result<Rc<Match_caseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Match_caseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 50, RULE_match_case);
...
impl<'input> TermContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<TermContextAll<'input>> {
		Rc::new(
...
pub trait TermContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<TermContextExt<'input>>{

fn spec_constant(&self) -> Option<Rc<Spec_constantContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn qual_identifier(&self) -> Option<Rc<Qual_identifierContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves all `TerminalNode`s corresponding to token ParOpen in current rule
fn ParOpen_all(&self) -> Vec<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn ParOpen(&self, i: usize) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
	self.get_token(ParOpen, i)
}
/// Retrieves all `TerminalNode`s corresponding to token ParClose in current rule
fn ParClose_all(&self) -> Vec<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>>  where Self:Sized{
	self.children_of_type()
}
...
fn ParClose(&self, i: usize) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
fn var_binding_all(&self) ->  Vec<Rc<Var_bindingContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn var_binding(&self, i: usize) -> Option<Rc<Var_bindingContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token GRW_Forall
/// Returns `None` if there is no child corresponding to token GRW_Forall
...
fn sorted_var_all(&self) ->  Vec<Rc<Sorted_varContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn sorted_var(&self, i: usize) -> Option<Rc<Sorted_varContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token GRW_Exists
/// Returns `None` if there is no child corresponding to token GRW_Exists
...
fn match_case_all(&self) ->  Vec<Rc<Match_caseContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn match_case(&self, i: usize) -> Option<Rc<Match_caseContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token GRW_Exclamation
/// Returns `None` if there is no child corresponding to token GRW_Exclamation
		...
		let result: Result<(), ANTLRError> = try {
			...
			,
				3 =>{
					...
					loop {
						...
						recog.err_handler.sync(&mut recog.base)?;
						_la = recog.base.input.la(1);
						if !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << ParOpen) | (1usize << String) | (1usize << QuotedSymbol) | (1usize << PS_Not) | (1usize << PS_Bool) | (1usize << PS_ContinuedExecution) | (1usize << PS_Error) | (1usize << PS_False) | (1usize << PS_ImmediateExit) | (1usize << PS_Incomplete) | (1usize << PS_Logic) | (1usize << PS_Memout) | (1usize << PS_Sat) | (1usize << PS_Success) | (1usize << PS_Theory) | (1usize << PS_True) | (1usize << PS_Unknown) | (1usize << PS_Unsupported) | (1usize << PS_Unsat))) != 0) || ((((_la - 66)) & !0x3f) == 0 && ((1usize << (_la - 66)) & ((1usize << (Numeral - 66)) | (1usize << (Binary - 66)) | (1usize << (HexDecimal - 66)) | (1usize << (Decimal - 66)) | (1usize << (UndefinedSymbol - 66)))) != 0)) {break}
					}
			...
			,
				8 =>{
					...
					recog.base.match_token(GRW_Exclamation,&mut recog.err_handler)?;
					...
					loop {
						...
						recog.err_handler.sync(&mut recog.base)?;
						_la = recog.base.input.la(1);
						if !(((((_la - 70)) & !0x3f) == 0 && ((1usize << (_la - 70)) & ((1usize << (Colon - 70)) | (1usize << (PK_AllStatistics - 70)) | (1usize << (PK_AssertionStackLevels - 70)) | (1usize << (PK_Authors - 70)) | (1usize << (PK_Category - 70)) | (1usize << (PK_Chainable - 70)) | (1usize << (PK_Definition - 70)) | (1usize << (PK_DiagnosticOutputChannel - 70)) | (1usize << (PK_ErrorBehaviour - 70)) | (1usize << (PK_Extension - 70)) | (1usize << (PK_Funs - 70)) | (1usize << (PK_FunsDescription - 70)) | (1usize << (PK_GlobalDeclarations - 70)) | (1usize << (PK_InteractiveMode - 70)) | (1usize << (PK_Language - 70)) | (1usize << (PK_LeftAssoc - 70)) | (1usize << (PK_License - 70)) | (1usize << (PK_Named - 70)) | (1usize << (PK_Name - 70)) | (1usize << (PK_Notes - 70)) | (1usize << (PK_Pattern - 70)) | (1usize << (PK_PrintSuccess - 70)) | (1usize << (PK_ProduceAssertions - 70)) | (1usize << (PK_ProduceAssignments - 70)) | (1usize << (PK_ProduceModels - 70)) | (1usize << (PK_ProduceProofs - 70)) | (1usize << (PK_ProduceUnsatAssumptions - 70)) | (1usize << (PK_ProduceUnsatCores - 70)) | (1usize << (PK_RandomSeed - 70)) | (1usize << (PK_ReasonUnknown - 70)) | (1usize << (PK_RegularOutputChannel - 70)) | (1usize << (PK_ReproducibleResourceLimit - 70)) | (1usize << (PK_RightAssoc - 70)) | (1usize << (PK_SmtLibVersion - 70)) | (1usize << (PK_Sorts - 70)) | (1usize << (PK_SortsDescription - 70)) | (1usize << (PK_Source - 70)) | (1usize << (PK_Status - 70)) | (1usize << (PK_Theories - 70)) | (1usize << (PK_Values - 70)) | (1usize << (PK_Verbosity - 70)) | (1usize << (PK_Version - 70)))) != 0)) {break}
					}
...
pub type Sort_symbol_declContext<'input> = BaseParserRuleContext<'input,Sort_symbol_declContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Sort_symbol_declContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_sort_symbol_decl }
...
impl<'input> Sort_symbol_declContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Sort_symbol_declContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Sort_symbol_declContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Sort_symbol_declContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Sort_symbol_declContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn sort_symbol_decl(&mut self,)
	-> Result<Rc<Sort_symbol_declContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Sort_symbol_declContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 54, RULE_sort_symbol_decl);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.err_handler.sync(&mut recog.base)?;
			_la = recog.base.input.la(1);
			while ((((_la - 70)) & !0x3f) == 0 && ((1usize << (_la - 70)) & ((1usize << (Colon - 70)) | (1usize << (PK_AllStatistics - 70)) | (1usize << (PK_AssertionStackLevels - 70)) | (1usize << (PK_Authors - 70)) | (1usize << (PK_Category - 70)) | (1usize << (PK_Chainable - 70)) | (1usize << (PK_Definition - 70)) | (1usize << (PK_DiagnosticOutputChannel - 70)) | (1usize << (PK_ErrorBehaviour - 70)) | (1usize << (PK_Extension - 70)) | (1usize << (PK_Funs - 70)) | (1usize << (PK_FunsDescription - 70)) | (1usize << (PK_GlobalDeclarations - 70)) | (1usize << (PK_InteractiveMode - 70)) | (1usize << (PK_Language - 70)) | (1usize << (PK_LeftAssoc - 70)) | (1usize << (PK_License - 70)) | (1usize << (PK_Named - 70)) | (1usize << (PK_Name - 70)) | (1usize << (PK_Notes - 70)) | (1usize << (PK_Pattern - 70)) | (1usize << (PK_PrintSuccess - 70)) | (1usize << (PK_ProduceAssertions - 70)) | (1usize << (PK_ProduceAssignments - 70)) | (1usize << (PK_ProduceModels - 70)) | (1usize << (PK_ProduceProofs - 70)) | (1usize << (PK_ProduceUnsatAssumptions - 70)) | (1usize << (PK_ProduceUnsatCores - 70)) | (1usize << (PK_RandomSeed - 70)) | (1usize << (PK_ReasonUnknown - 70)) | (1usize << (PK_RegularOutputChannel - 70)) | (1usize << (PK_ReproducibleResourceLimit - 70)) | (1usize << (PK_RightAssoc - 70)) | (1usize << (PK_SmtLibVersion - 70)) | (1usize << (PK_Sorts - 70)) | (1usize << (PK_SortsDescription - 70)) | (1usize << (PK_Source - 70)) | (1usize << (PK_Status - 70)) | (1usize << (PK_Theories - 70)) | (1usize << (PK_Values - 70)) | (1usize << (PK_Verbosity - 70)) | (1usize << (PK_Version - 70)))) != 0) {
				{
				{
				/*InvokeRule attribute*/
...
pub type Meta_spec_constantContext<'input> = BaseParserRuleContext<'input,Meta_spec_constantContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Meta_spec_constantContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Meta_spec_constantContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_meta_spec_constant }
...
impl<'input> Meta_spec_constantContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Meta_spec_constantContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Meta_spec_constantContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Meta_spec_constantContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Meta_spec_constantContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn meta_spec_constant(&mut self,)
	-> Result<Rc<Meta_spec_constantContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Meta_spec_constantContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 56, RULE_meta_spec_constant);
		...
		let result: Result<(), ANTLRError> = try {
			...
			_la = recog.base.input.la(1);
			if { !(((((_la - 57)) & !0x3f) == 0 && ((1usize << (_la - 57)) & ((1usize << (GRW_Decimal - 57)) | (1usize << (GRW_Numeral - 57)) | (1usize << (GRW_String - 57)))) != 0)) } {
				recog.err_handler.recover_inline(&mut recog.base)?;
...
pub type Fun_symbol_declContext<'input> = BaseParserRuleContext<'input,Fun_symbol_declContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Fun_symbol_declContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_fun_symbol_decl }
...
impl<'input> Fun_symbol_declContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Fun_symbol_declContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Fun_symbol_declContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Fun_symbol_declContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Fun_symbol_declContextExt<'input>>{
...
fn meta_spec_constant(&self) -> Option<Rc<Meta_spec_constantContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn identifier(&self) -> Option<Rc<IdentifierContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn fun_symbol_decl(&mut self,)
	-> Result<Rc<Fun_symbol_declContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Fun_symbol_declContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 58, RULE_fun_symbol_decl);
...
pub type Par_fun_symbol_declContext<'input> = BaseParserRuleContext<'input,Par_fun_symbol_declContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Par_fun_symbol_declContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Par_fun_symbol_declContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_par_fun_symbol_decl }
...
impl<'input> Par_fun_symbol_declContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Par_fun_symbol_declContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Par_fun_symbol_declContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Par_fun_symbol_declContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Par_fun_symbol_declContextExt<'input>>{

fn fun_symbol_decl(&self) -> Option<Rc<Fun_symbol_declContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves all `TerminalNode`s corresponding to token ParOpen in current rule
fn ParOpen_all(&self) -> Vec<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>>  where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn par_fun_symbol_decl(&mut self,)
	-> Result<Rc<Par_fun_symbol_declContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Par_fun_symbol_declContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 60, RULE_par_fun_symbol_decl);
...
pub type Theory_attributeContext<'input> = BaseParserRuleContext<'input,Theory_attributeContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Theory_attributeContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_theory_attribute }
...
impl<'input> Theory_attributeContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Theory_attributeContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Theory_attributeContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Theory_attributeContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Theory_attributeContextExt<'input>>{
...
fn sort_symbol_decl_all(&self) ->  Vec<Rc<Sort_symbol_declContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn sort_symbol_decl(&self, i: usize) -> Option<Rc<Sort_symbol_declContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token PK_Funs
/// Returns `None` if there is no child corresponding to token PK_Funs
...
fn par_fun_symbol_decl_all(&self) ->  Vec<Rc<Par_fun_symbol_declContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn par_fun_symbol_decl(&self, i: usize) -> Option<Rc<Par_fun_symbol_declContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token PK_SortsDescription
/// Returns `None` if there is no child corresponding to token PK_SortsDescription
...
fn attribute(&self) -> Option<Rc<AttributeContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn theory_attribute(&mut self,)
	-> Result<Rc<Theory_attributeContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Theory_attributeContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 62, RULE_theory_attribute);
		...
		let result: Result<(), ANTLRError> = try {
			...
			,
				3 =>{
					...
					recog.base.match_token(PK_SortsDescription,&mut recog.err_handler)?;
			...
			,
				4 =>{
					...
					recog.base.match_token(PK_FunsDescription,&mut recog.err_handler)?;
			...
			,
				5 =>{
					...
					recog.base.match_token(PK_Definition,&mut recog.err_handler)?;
...
impl<'input> CustomRuleContext<'input> for Theory_declContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_theory_decl }
...
impl<'input> Theory_declContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Theory_declContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Theory_declContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Theory_declContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Theory_declContextExt<'input>>{
...
fn theory_attribute_all(&self) ->  Vec<Rc<Theory_attributeContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn theory_attribute(&self, i: usize) -> Option<Rc<Theory_attributeContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn theory_decl(&mut self,)
	-> Result<Rc<Theory_declContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Theory_declContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 64, RULE_theory_decl);
...
pub type Logic_attribueContext<'input> = BaseParserRuleContext<'input,Logic_attribueContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Logic_attribueContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_logic_attribue }
...
impl<'input> Logic_attribueContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Logic_attribueContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Logic_attribueContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Logic_attribueContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Logic_attribueContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn logic_attribue(&mut self,)
	-> Result<Rc<Logic_attribueContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Logic_attribueContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 66, RULE_logic_attribue);
		...
		let result: Result<(), ANTLRError> = try {
			...
			match  recog.interpreter.adaptive_predict(39,&mut recog.base)? {
				1 =>{
					...
					recog.base.match_token(PK_Theories,&mut recog.err_handler)?;
			...
			,
				2 =>{
					...
					recog.base.match_token(PK_Language,&mut recog.err_handler)?;
			...
			,
				3 =>{
					...
					recog.base.match_token(PK_Extension,&mut recog.err_handler)?;
...
impl<'input> CustomRuleContext<'input> for LogicContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_logic }
	//fn type_rule_index() -> usize where Self: Sized { RULE_logic }
}
antlr_rust::type_id!{LogicContextExt<'a>}

impl<'input> LogicContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<LogicContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,LogicContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait LogicContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<LogicContextExt<'input>>{
...
fn logic_attribue_all(&self) ->  Vec<Rc<Logic_attribueContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn logic_attribue(&self, i: usize) -> Option<Rc<Logic_attribueContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<LogicContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> CustomRuleContext<'input> for Sort_decContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_sort_dec }
...
impl<'input> Sort_decContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Sort_decContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Sort_decContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Sort_decContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Sort_decContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn sort_dec(&mut self,)
	-> Result<Rc<Sort_decContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Selector_decContext<'input> = BaseParserRuleContext<'input,Selector_decContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Selector_decContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_selector_dec }
...
impl<'input> Selector_decContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Selector_decContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Selector_decContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Selector_decContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Selector_decContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn selector_dec(&mut self,)
	-> Result<Rc<Selector_decContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Selector_decContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 72, RULE_selector_dec);
...
pub type Constructor_decContext<'input> = BaseParserRuleContext<'input,Constructor_decContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Constructor_decContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_constructor_dec }
...
impl<'input> Constructor_decContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Constructor_decContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Constructor_decContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Constructor_decContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Constructor_decContextExt<'input>>{
...
fn selector_dec_all(&self) ->  Vec<Rc<Selector_decContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn selector_dec(&self, i: usize) -> Option<Rc<Selector_decContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn constructor_dec(&mut self,)
	-> Result<Rc<Constructor_decContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Constructor_decContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 74, RULE_constructor_dec);
...
pub type Datatype_decContext<'input> = BaseParserRuleContext<'input,Datatype_decContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Datatype_decContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_datatype_dec }
...
impl<'input> Datatype_decContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Datatype_decContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Datatype_decContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Datatype_decContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Datatype_decContextExt<'input>>{
...
fn constructor_dec_all(&self) ->  Vec<Rc<Constructor_decContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn constructor_dec(&self, i: usize) -> Option<Rc<Constructor_decContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
/// Retrieves first TerminalNode corresponding to token GRW_Par
/// Returns `None` if there is no child corresponding to token GRW_Par
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn datatype_dec(&mut self,)
	-> Result<Rc<Datatype_decContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Datatype_decContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 76, RULE_datatype_dec);
...
pub type Function_decContext<'input> = BaseParserRuleContext<'input,Function_decContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Function_decContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_function_dec }
...
impl<'input> Function_decContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Function_decContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Function_decContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Function_decContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Function_decContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn function_dec(&mut self,)
	-> Result<Rc<Function_decContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Function_decContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 78, RULE_function_dec);
...
impl<'input> Function_defContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Function_defContextAll<'input>> {
		Rc::new(
...
pub trait Function_defContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Function_defContextExt<'input>>{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Function_defContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 80, RULE_function_def);
...
pub type Prop_literalContext<'input> = BaseParserRuleContext<'input,Prop_literalContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Prop_literalContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_prop_literal }
...
impl<'input> Prop_literalContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Prop_literalContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Prop_literalContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Prop_literalContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Prop_literalContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn prop_literal(&mut self,)
	-> Result<Rc<Prop_literalContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Prop_literalContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 82, RULE_prop_literal);
...
impl<'input> ScriptContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<ScriptContextAll<'input>> {
		Rc::new(
...
pub trait ScriptContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<ScriptContextExt<'input>>{
...
impl<'input> CustomRuleContext<'input> for Cmd_assertContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_assert }
...
impl<'input> Cmd_assertContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_assertContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_assertContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_assertContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_assertContextExt<'input>>{
...
fn CMD_Assert(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_assert(&mut self,)
	-> Result<Rc<Cmd_assertContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_assertContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 86, RULE_cmd_assert);
...
pub type Cmd_checkSatContext<'input> = BaseParserRuleContext<'input,Cmd_checkSatContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Cmd_checkSatContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_checkSat }
...
impl<'input> Cmd_checkSatContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_checkSatContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_checkSatContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_checkSatContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_checkSatContextExt<'input>>{
...
fn CMD_CheckSat(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_checkSat(&mut self,)
	-> Result<Rc<Cmd_checkSatContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_checkSatContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 88, RULE_cmd_checkSat);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_CheckSat,&mut recog.err_handler)?;
...
pub type Cmd_checkSatAssumingContext<'input> = BaseParserRuleContext<'input,Cmd_checkSatAssumingContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Cmd_checkSatAssumingContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Cmd_checkSatAssumingContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_checkSatAssuming }
...
impl<'input> Cmd_checkSatAssumingContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_checkSatAssumingContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_checkSatAssumingContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_checkSatAssumingContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_checkSatAssumingContextExt<'input>>{
...
fn CMD_CheckSatAssuming(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_checkSatAssuming(&mut self,)
	-> Result<Rc<Cmd_checkSatAssumingContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_checkSatAssumingContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 90, RULE_cmd_checkSatAssuming);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_CheckSatAssuming,&mut recog.err_handler)?;
...
pub type Cmd_declareConstContext<'input> = BaseParserRuleContext<'input,Cmd_declareConstContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Cmd_declareConstContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_declareConst }
...
impl<'input> Cmd_declareConstContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_declareConstContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_declareConstContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_declareConstContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_declareConstContextExt<'input>>{
...
fn CMD_DeclareConst(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_declareConst(&mut self,)
	-> Result<Rc<Cmd_declareConstContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_declareConstContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 92, RULE_cmd_declareConst);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_DeclareConst,&mut recog.err_handler)?;
...
pub type Cmd_declareDatatypeContext<'input> = BaseParserRuleContext<'input,Cmd_declareDatatypeContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Cmd_declareDatatypeContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Cmd_declareDatatypeContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_declareDatatype }
...
impl<'input> Cmd_declareDatatypeContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_declareDatatypeContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_declareDatatypeContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_declareDatatypeContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_declareDatatypeContextExt<'input>>{
...
fn CMD_DeclareDatatype(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_declareDatatype(&mut self,)
	-> Result<Rc<Cmd_declareDatatypeContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_declareDatatypeContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 94, RULE_cmd_declareDatatype);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_DeclareDatatype,&mut recog.err_handler)?;
...
pub type Cmd_declareDatatypesContext<'input> = BaseParserRuleContext<'input,Cmd_declareDatatypesContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Cmd_declareDatatypesContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Cmd_declareDatatypesContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_declareDatatypes }
...
impl<'input> Cmd_declareDatatypesContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_declareDatatypesContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_declareDatatypesContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_declareDatatypesContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_declareDatatypesContextExt<'input>>{
...
fn CMD_DeclareDatatypes(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_declareDatatypes(&mut self,)
	-> Result<Rc<Cmd_declareDatatypesContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_declareDatatypesContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 96, RULE_cmd_declareDatatypes);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_DeclareDatatypes,&mut recog.err_handler)?;
...
pub type Cmd_declareFunContext<'input> = BaseParserRuleContext<'input,Cmd_declareFunContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Cmd_declareFunContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_declareFun }
...
impl<'input> Cmd_declareFunContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_declareFunContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_declareFunContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_declareFunContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_declareFunContextExt<'input>>{
...
fn CMD_DeclareFun(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_declareFun(&mut self,)
	-> Result<Rc<Cmd_declareFunContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_declareFunContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 98, RULE_cmd_declareFun);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_DeclareFun,&mut recog.err_handler)?;
...
pub type Cmd_declareSortContext<'input> = BaseParserRuleContext<'input,Cmd_declareSortContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Cmd_declareSortContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_declareSort }
...
impl<'input> Cmd_declareSortContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_declareSortContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_declareSortContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_declareSortContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_declareSortContextExt<'input>>{
...
fn CMD_DeclareSort(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_declareSort(&mut self,)
	-> Result<Rc<Cmd_declareSortContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_declareSortContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 100, RULE_cmd_declareSort);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_DeclareSort,&mut recog.err_handler)?;
...
pub type Cmd_defineFunContext<'input> = BaseParserRuleContext<'input,Cmd_defineFunContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Cmd_defineFunContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_defineFun }
...
impl<'input> Cmd_defineFunContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_defineFunContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_defineFunContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_defineFunContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_defineFunContextExt<'input>>{
...
fn CMD_DefineFun(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_defineFun(&mut self,)
	-> Result<Rc<Cmd_defineFunContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_defineFunContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 102, RULE_cmd_defineFun);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_DefineFun,&mut recog.err_handler)?;
...
pub type Cmd_defineFunRecContext<'input> = BaseParserRuleContext<'input,Cmd_defineFunRecContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Cmd_defineFunRecContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_defineFunRec }
...
impl<'input> Cmd_defineFunRecContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_defineFunRecContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_defineFunRecContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_defineFunRecContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_defineFunRecContextExt<'input>>{
...
fn CMD_DefineFunRec(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_defineFunRec(&mut self,)
	-> Result<Rc<Cmd_defineFunRecContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_defineFunRecContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 104, RULE_cmd_defineFunRec);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_DefineFunRec,&mut recog.err_handler)?;
...
pub type Cmd_defineFunsRecContext<'input> = BaseParserRuleContext<'input,Cmd_defineFunsRecContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Cmd_defineFunsRecContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Cmd_defineFunsRecContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_defineFunsRec }
...
impl<'input> Cmd_defineFunsRecContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_defineFunsRecContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_defineFunsRecContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_defineFunsRecContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_defineFunsRecContextExt<'input>>{
...
fn CMD_DefineFunsRec(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_defineFunsRec(&mut self,)
	-> Result<Rc<Cmd_defineFunsRecContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_defineFunsRecContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 106, RULE_cmd_defineFunsRec);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_DefineFunsRec,&mut recog.err_handler)?;
...
pub type Cmd_defineSortContext<'input> = BaseParserRuleContext<'input,Cmd_defineSortContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Cmd_defineSortContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_defineSort }
...
impl<'input> Cmd_defineSortContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_defineSortContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_defineSortContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_defineSortContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_defineSortContextExt<'input>>{
...
fn CMD_DefineSort(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_defineSort(&mut self,)
	-> Result<Rc<Cmd_defineSortContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_defineSortContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 108, RULE_cmd_defineSort);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_DefineSort,&mut recog.err_handler)?;
...
impl<'input> CustomRuleContext<'input> for Cmd_echoContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_echo }
...
impl<'input> Cmd_echoContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_echoContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_echoContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_echoContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_echoContextExt<'input>>{
...
fn CMD_Echo(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_echo(&mut self,)
	-> Result<Rc<Cmd_echoContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> CustomRuleContext<'input> for Cmd_exitContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_exit }
...
impl<'input> Cmd_exitContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_exitContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_exitContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_exitContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_exitContextExt<'input>>{
...
fn CMD_Exit(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Cmd_exitContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
pub type Cmd_getAssertionsContext<'input> = BaseParserRuleContext<'input,Cmd_getAssertionsContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Cmd_getAssertionsContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Cmd_getAssertionsContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_getAssertions }
...
impl<'input> Cmd_getAssertionsContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_getAssertionsContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_getAssertionsContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_getAssertionsContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_getAssertionsContextExt<'input>>{
...
fn CMD_GetAssertions(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_getAssertions(&mut self,)
	-> Result<Rc<Cmd_getAssertionsContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_getAssertionsContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 114, RULE_cmd_getAssertions);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_GetAssertions,&mut recog.err_handler)?;
...
pub type Cmd_getAssignmentContext<'input> = BaseParserRuleContext<'input,Cmd_getAssignmentContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Cmd_getAssignmentContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Cmd_getAssignmentContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_getAssignment }
...
impl<'input> Cmd_getAssignmentContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_getAssignmentContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_getAssignmentContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_getAssignmentContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_getAssignmentContextExt<'input>>{
...
fn CMD_GetAssignment(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_getAssignment(&mut self,)
	-> Result<Rc<Cmd_getAssignmentContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_getAssignmentContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 116, RULE_cmd_getAssignment);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_GetAssignment,&mut recog.err_handler)?;
...
impl<'input> CustomRuleContext<'input> for Cmd_getInfoContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_getInfo }
...
impl<'input> Cmd_getInfoContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_getInfoContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_getInfoContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_getInfoContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_getInfoContextExt<'input>>{
...
fn CMD_GetInfo(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_getInfo(&mut self,)
	-> Result<Rc<Cmd_getInfoContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_getInfoContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 118, RULE_cmd_getInfo);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_GetInfo,&mut recog.err_handler)?;
...
pub type Cmd_getModelContext<'input> = BaseParserRuleContext<'input,Cmd_getModelContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Cmd_getModelContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_getModel }
...
impl<'input> Cmd_getModelContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_getModelContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_getModelContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_getModelContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_getModelContextExt<'input>>{
...
fn CMD_GetModel(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_getModel(&mut self,)
	-> Result<Rc<Cmd_getModelContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_getModelContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 120, RULE_cmd_getModel);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_GetModel,&mut recog.err_handler)?;
...
pub type Cmd_getOptionContext<'input> = BaseParserRuleContext<'input,Cmd_getOptionContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Cmd_getOptionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_getOption }
...
impl<'input> Cmd_getOptionContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_getOptionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_getOptionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_getOptionContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_getOptionContextExt<'input>>{
...
fn CMD_GetOption(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_getOption(&mut self,)
	-> Result<Rc<Cmd_getOptionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_getOptionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 122, RULE_cmd_getOption);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_GetOption,&mut recog.err_handler)?;
...
pub type Cmd_getProofContext<'input> = BaseParserRuleContext<'input,Cmd_getProofContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Cmd_getProofContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_getProof }
...
impl<'input> Cmd_getProofContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_getProofContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_getProofContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_getProofContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_getProofContextExt<'input>>{
...
fn CMD_GetProof(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_getProof(&mut self,)
	-> Result<Rc<Cmd_getProofContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_getProofContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 124, RULE_cmd_getProof);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_GetProof,&mut recog.err_handler)?;
...
pub type Cmd_getUnsatAssumptionsContext<'input> = BaseParserRuleContext<'input,Cmd_getUnsatAssumptionsContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Cmd_getUnsatAssumptionsContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Cmd_getUnsatAssumptionsContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_getUnsatAssumptions }
...
impl<'input> Cmd_getUnsatAssumptionsContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_getUnsatAssumptionsContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_getUnsatAssumptionsContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_getUnsatAssumptionsContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_getUnsatAssumptionsContextExt<'input>>{
...
fn CMD_GetUnsatAssumptions(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
	self.get_token(CMD_GetUnsatAssumptions, 0)
}

}

impl<'input> Cmd_getUnsatAssumptionsContextAttrs<'input> for Cmd_getUnsatAssumptionsContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_getUnsatAssumptions(&mut self,)
	-> Result<Rc<Cmd_getUnsatAssumptionsContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_getUnsatAssumptionsContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 126, RULE_cmd_getUnsatAssumptions);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_GetUnsatAssumptions,&mut recog.err_handler)?;
...
pub type Cmd_getUnsatCoreContext<'input> = BaseParserRuleContext<'input,Cmd_getUnsatCoreContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Cmd_getUnsatCoreContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_getUnsatCore }
...
impl<'input> Cmd_getUnsatCoreContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_getUnsatCoreContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_getUnsatCoreContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_getUnsatCoreContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_getUnsatCoreContextExt<'input>>{
...
fn CMD_GetUnsatCore(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_getUnsatCore(&mut self,)
	-> Result<Rc<Cmd_getUnsatCoreContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_getUnsatCoreContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 128, RULE_cmd_getUnsatCore);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_GetUnsatCore,&mut recog.err_handler)?;
...
pub type Cmd_getValueContext<'input> = BaseParserRuleContext<'input,Cmd_getValueContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Cmd_getValueContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_getValue }
...
impl<'input> Cmd_getValueContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_getValueContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_getValueContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_getValueContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_getValueContextExt<'input>>{
...
fn CMD_GetValue(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_getValue(&mut self,)
	-> Result<Rc<Cmd_getValueContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_getValueContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 130, RULE_cmd_getValue);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_GetValue,&mut recog.err_handler)?;
...
impl<'input> CustomRuleContext<'input> for Cmd_popContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_pop }
...
impl<'input> Cmd_popContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_popContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_popContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_popContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_popContextExt<'input>>{
...
fn CMD_Pop(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_pop(&mut self,)
	-> Result<Rc<Cmd_popContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> CustomRuleContext<'input> for Cmd_pushContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_push }
...
impl<'input> Cmd_pushContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_pushContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_pushContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_pushContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_pushContextExt<'input>>{
...
fn CMD_Push(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_push(&mut self,)
	-> Result<Rc<Cmd_pushContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> CustomRuleContext<'input> for Cmd_resetContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_reset }
...
impl<'input> Cmd_resetContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_resetContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_resetContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_resetContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_resetContextExt<'input>>{
...
fn CMD_Reset(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Cmd_resetContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_resetContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 136, RULE_cmd_reset);
...
pub type Cmd_resetAssertionsContext<'input> = BaseParserRuleContext<'input,Cmd_resetAssertionsContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Cmd_resetAssertionsContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Cmd_resetAssertionsContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_resetAssertions }
...
impl<'input> Cmd_resetAssertionsContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_resetAssertionsContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_resetAssertionsContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_resetAssertionsContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_resetAssertionsContextExt<'input>>{
...
fn CMD_ResetAssertions(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_resetAssertions(&mut self,)
	-> Result<Rc<Cmd_resetAssertionsContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_resetAssertionsContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 138, RULE_cmd_resetAssertions);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_ResetAssertions,&mut recog.err_handler)?;
...
impl<'input> CustomRuleContext<'input> for Cmd_setInfoContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_setInfo }
...
impl<'input> Cmd_setInfoContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_setInfoContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_setInfoContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_setInfoContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_setInfoContextExt<'input>>{
...
fn CMD_SetInfo(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_setInfo(&mut self,)
	-> Result<Rc<Cmd_setInfoContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_setInfoContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 140, RULE_cmd_setInfo);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_SetInfo,&mut recog.err_handler)?;
...
pub type Cmd_setLogicContext<'input> = BaseParserRuleContext<'input,Cmd_setLogicContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Cmd_setLogicContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_setLogic }
...
impl<'input> Cmd_setLogicContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_setLogicContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_setLogicContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_setLogicContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_setLogicContextExt<'input>>{
...
fn CMD_SetLogic(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_setLogic(&mut self,)
	-> Result<Rc<Cmd_setLogicContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_setLogicContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 142, RULE_cmd_setLogic);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_SetLogic,&mut recog.err_handler)?;
...
pub type Cmd_setOptionContext<'input> = BaseParserRuleContext<'input,Cmd_setOptionContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Cmd_setOptionContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_cmd_setOption }
...
impl<'input> Cmd_setOptionContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Cmd_setOptionContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Cmd_setOptionContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Cmd_setOptionContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Cmd_setOptionContextExt<'input>>{
...
fn CMD_SetOption(&self) -> Option<Rc<TerminalNode<'input,SMTLIBv2ParserContextType>>> where Self:Sized{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn cmd_setOption(&mut self,)
	-> Result<Rc<Cmd_setOptionContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Cmd_setOptionContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 144, RULE_cmd_setOption);
		...
		let result: Result<(), ANTLRError> = try {
			...
			recog.base.match_token(CMD_SetOption,&mut recog.err_handler)?;
...
impl<'input> CommandContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<CommandContextAll<'input>> {
		Rc::new(
...
pub trait CommandContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<CommandContextExt<'input>>{
...
fn cmd_assert(&self) -> Option<Rc<Cmd_assertContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn term_all(&self) ->  Vec<Rc<TermContextAll<'input>>> where Self:Sized{
	self.children_of_type()
...
fn cmd_checkSat(&self) -> Option<Rc<Cmd_checkSatContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_checkSatAssuming(&self) -> Option<Rc<Cmd_checkSatAssumingContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_declareConst(&self) -> Option<Rc<Cmd_declareConstContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn symbol_all(&self) ->  Vec<Rc<SymbolContextAll<'input>>> where Self:Sized{
	self.children_of_type()
...
fn cmd_declareDatatype(&self) -> Option<Rc<Cmd_declareDatatypeContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn datatype_dec_all(&self) ->  Vec<Rc<Datatype_decContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn datatype_dec(&self, i: usize) -> Option<Rc<Datatype_decContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn cmd_declareDatatypes(&self) -> Option<Rc<Cmd_declareDatatypesContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn sort_dec_all(&self) ->  Vec<Rc<Sort_decContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn sort_dec(&self, i: usize) -> Option<Rc<Sort_decContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn cmd_declareFun(&self) -> Option<Rc<Cmd_declareFunContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_declareSort(&self) -> Option<Rc<Cmd_declareSortContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn numeral(&self) -> Option<Rc<NumeralContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_defineFun(&self) -> Option<Rc<Cmd_defineFunContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn function_def(&self) -> Option<Rc<Function_defContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_defineFunRec(&self) -> Option<Rc<Cmd_defineFunRecContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_defineFunsRec(&self) -> Option<Rc<Cmd_defineFunsRecContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn function_dec_all(&self) ->  Vec<Rc<Function_decContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn function_dec(&self, i: usize) -> Option<Rc<Function_decContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
fn cmd_defineSort(&self) -> Option<Rc<Cmd_defineSortContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_echo(&self) -> Option<Rc<Cmd_echoContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn string(&self) -> Option<Rc<StringContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_exit(&self) -> Option<Rc<Cmd_exitContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_getAssertions(&self) -> Option<Rc<Cmd_getAssertionsContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_getAssignment(&self) -> Option<Rc<Cmd_getAssignmentContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_getInfo(&self) -> Option<Rc<Cmd_getInfoContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn info_flag(&self) -> Option<Rc<Info_flagContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_getModel(&self) -> Option<Rc<Cmd_getModelContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_getOption(&self) -> Option<Rc<Cmd_getOptionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn keyword(&self) -> Option<Rc<KeywordContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_getProof(&self) -> Option<Rc<Cmd_getProofContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_getUnsatAssumptions(&self) -> Option<Rc<Cmd_getUnsatAssumptionsContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_getUnsatCore(&self) -> Option<Rc<Cmd_getUnsatCoreContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_getValue(&self) -> Option<Rc<Cmd_getValueContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_pop(&self) -> Option<Rc<Cmd_popContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_push(&self) -> Option<Rc<Cmd_pushContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_reset(&self) -> Option<Rc<Cmd_resetContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_resetAssertions(&self) -> Option<Rc<Cmd_resetAssertionsContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_setInfo(&self) -> Option<Rc<Cmd_setInfoContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn attribute(&self) -> Option<Rc<AttributeContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_setLogic(&self) -> Option<Rc<Cmd_setLogicContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn cmd_setOption(&self) -> Option<Rc<Cmd_setOptionContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
		...
		let result: Result<(), ANTLRError> = try {
			...
			,
				7 =>{
					...
					recog.err_handler.sync(&mut recog.base)?;
					_la = recog.base.input.la(1);
					while (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << ParOpen) | (1usize << QuotedSymbol) | (1usize << PS_Not) | (1usize << PS_Bool) | (1usize << PS_ContinuedExecution) | (1usize << PS_Error) | (1usize << PS_False) | (1usize << PS_ImmediateExit) | (1usize << PS_Incomplete) | (1usize << PS_Logic) | (1usize << PS_Memout) | (1usize << PS_Sat) | (1usize << PS_Success) | (1usize << PS_Theory) | (1usize << PS_True) | (1usize << PS_Unknown) | (1usize << PS_Unsupported) | (1usize << PS_Unsat))) != 0) || _la==UndefinedSymbol {
						{
						{
						/*InvokeRule sort*/
			...
			,
				12 =>{
					...
					recog.err_handler.sync(&mut recog.base)?;
					_la = recog.base.input.la(1);
					while (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << QuotedSymbol) | (1usize << PS_Not) | (1usize << PS_Bool) | (1usize << PS_ContinuedExecution) | (1usize << PS_Error) | (1usize << PS_False) | (1usize << PS_ImmediateExit) | (1usize << PS_Incomplete) | (1usize << PS_Logic) | (1usize << PS_Memout) | (1usize << PS_Sat) | (1usize << PS_Success) | (1usize << PS_Theory) | (1usize << PS_True) | (1usize << PS_Unknown) | (1usize << PS_Unsupported) | (1usize << PS_Unsat))) != 0) || _la==UndefinedSymbol {
						{
						{
						/*InvokeRule symbol*/
...
impl<'input> CustomRuleContext<'input> for B_valueContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_b_value }
...
impl<'input> B_valueContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<B_valueContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,B_valueContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait B_valueContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<B_valueContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn b_value(&mut self,)
	-> Result<Rc<B_valueContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
...
impl<'input> OptionContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<OptionContextAll<'input>> {
		Rc::new(
...
pub trait OptionContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<OptionContextExt<'input>>{
...
fn b_value(&self) -> Option<Rc<B_valueContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token PK_InteractiveMode
/// Returns `None` if there is no child corresponding to token PK_InteractiveMode
		...
		let result: Result<(), ANTLRError> = try {
			...
			match  recog.interpreter.adaptive_predict(58,&mut recog.base)? {
				1 =>{
					...
					recog.base.match_token(PK_DiagnosticOutputChannel,&mut recog.err_handler)?;
			...
			,
				2 =>{
					...
					recog.base.match_token(PK_GlobalDeclarations,&mut recog.err_handler)?;
			...
			,
				3 =>{
					...
					recog.base.match_token(PK_InteractiveMode,&mut recog.err_handler)?;
			...
			,
				4 =>{
					...
					recog.base.match_token(PK_PrintSuccess,&mut recog.err_handler)?;
			...
			,
				5 =>{
					...
					recog.base.match_token(PK_ProduceAssertions,&mut recog.err_handler)?;
			...
			,
				6 =>{
					...
					recog.base.match_token(PK_ProduceAssignments,&mut recog.err_handler)?;
			...
			,
				7 =>{
					...
					recog.base.match_token(PK_ProduceModels,&mut recog.err_handler)?;
			...
			,
				8 =>{
					...
					recog.base.match_token(PK_ProduceProofs,&mut recog.err_handler)?;
			...
			,
				9 =>{
					...
					recog.base.match_token(PK_ProduceUnsatAssumptions,&mut recog.err_handler)?;
			...
			,
				10 =>{
					...
					recog.base.match_token(PK_ProduceUnsatCores,&mut recog.err_handler)?;
			...
			,
				11 =>{
					...
					recog.base.match_token(PK_RandomSeed,&mut recog.err_handler)?;
			...
			,
				12 =>{
					...
					recog.base.match_token(PK_RegularOutputChannel,&mut recog.err_handler)?;
			...
			,
				13 =>{
					...
					recog.base.match_token(PK_ReproducibleResourceLimit,&mut recog.err_handler)?;
			...
			,
				14 =>{
					...
					recog.base.match_token(PK_Verbosity,&mut recog.err_handler)?;
...
impl<'input> CustomRuleContext<'input> for Info_flagContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_info_flag }
...
impl<'input> Info_flagContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Info_flagContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Info_flagContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Info_flagContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Info_flagContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn info_flag(&mut self,)
	-> Result<Rc<Info_flagContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Info_flagContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 152, RULE_info_flag);
		...
		let result: Result<(), ANTLRError> = try {
			...
			match  recog.interpreter.adaptive_predict(59,&mut recog.base)? {
				1 =>{
					...
					recog.base.match_token(PK_AllStatistics,&mut recog.err_handler)?;
			...
			,
				2 =>{
					...
					recog.base.match_token(PK_AssertionStackLevels,&mut recog.err_handler)?;
			...
			,
				4 =>{
					...
					recog.base.match_token(PK_ErrorBehaviour,&mut recog.err_handler)?;
			...
			,
				6 =>{
					...
					recog.base.match_token(PK_ReasonUnknown,&mut recog.err_handler)?;
...
pub type Error_behaviourContext<'input> = BaseParserRuleContext<'input,Error_behaviourContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Error_behaviourContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_error_behaviour }
...
impl<'input> Error_behaviourContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Error_behaviourContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Error_behaviourContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Error_behaviourContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Error_behaviourContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn error_behaviour(&mut self,)
	-> Result<Rc<Error_behaviourContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Error_behaviourContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 154, RULE_error_behaviour);
...
pub type Reason_unknownContext<'input> = BaseParserRuleContext<'input,Reason_unknownContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Reason_unknownContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_reason_unknown }
...
impl<'input> Reason_unknownContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Reason_unknownContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Reason_unknownContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Reason_unknownContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Reason_unknownContextExt<'input>>{
...
fn s_expr(&self) -> Option<Rc<S_exprContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn reason_unknown(&mut self,)
	-> Result<Rc<Reason_unknownContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Reason_unknownContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 156, RULE_reason_unknown);
		...
		let result: Result<(), ANTLRError> = try {
			...
			,
				2 =>{
					...
					recog.base.match_token(PS_Incomplete,&mut recog.err_handler)?;
...
pub type Model_responseContext<'input> = BaseParserRuleContext<'input,Model_responseContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Model_responseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_model_response }
...
impl<'input> Model_responseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Model_responseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Model_responseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Model_responseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Model_responseContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn model_response(&mut self,)
	-> Result<Rc<Model_responseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Model_responseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 158, RULE_model_response);
...
pub type Info_responseContext<'input> = BaseParserRuleContext<'input,Info_responseContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Info_responseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_info_response }
...
impl<'input> Info_responseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Info_responseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Info_responseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Info_responseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Info_responseContextExt<'input>>{
...
fn error_behaviour(&self) -> Option<Rc<Error_behaviourContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token PK_Name
/// Returns `None` if there is no child corresponding to token PK_Name
...
fn reason_unknown(&self) -> Option<Rc<Reason_unknownContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token PK_Version
/// Returns `None` if there is no child corresponding to token PK_Version
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn info_response(&mut self,)
	-> Result<Rc<Info_responseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Info_responseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 160, RULE_info_response);
...
pub type Valuation_pairContext<'input> = BaseParserRuleContext<'input,Valuation_pairContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Valuation_pairContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_valuation_pair }
...
impl<'input> Valuation_pairContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Valuation_pairContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Valuation_pairContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Valuation_pairContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Valuation_pairContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn valuation_pair(&mut self,)
	-> Result<Rc<Valuation_pairContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Valuation_pairContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 162, RULE_valuation_pair);
...
pub type T_valuation_pairContext<'input> = BaseParserRuleContext<'input,T_valuation_pairContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for T_valuation_pairContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_t_valuation_pair }
...
impl<'input> T_valuation_pairContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<T_valuation_pairContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,T_valuation_pairContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait T_valuation_pairContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<T_valuation_pairContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn t_valuation_pair(&mut self,)
	-> Result<Rc<T_valuation_pairContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = T_valuation_pairContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 164, RULE_t_valuation_pair);
...
pub type Check_sat_responseContext<'input> = BaseParserRuleContext<'input,Check_sat_responseContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Check_sat_responseContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Check_sat_responseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_check_sat_response }
...
impl<'input> Check_sat_responseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Check_sat_responseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Check_sat_responseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Check_sat_responseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Check_sat_responseContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn check_sat_response(&mut self,)
	-> Result<Rc<Check_sat_responseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Check_sat_responseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 166, RULE_check_sat_response);
		...
		let result: Result<(), ANTLRError> = try {
			...
			_la = recog.base.input.la(1);
			if { !((((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << PS_Sat) | (1usize << PS_Unknown) | (1usize << PS_Unsat))) != 0)) } {
				recog.err_handler.recover_inline(&mut recog.base)?;
...
pub type Echo_responseContext<'input> = BaseParserRuleContext<'input,Echo_responseContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for Echo_responseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_echo_response }
...
impl<'input> Echo_responseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Echo_responseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Echo_responseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Echo_responseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Echo_responseContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn echo_response(&mut self,)
	-> Result<Rc<Echo_responseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Echo_responseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 168, RULE_echo_response);
...
pub type Get_assertions_responseContext<'input> = BaseParserRuleContext<'input,Get_assertions_responseContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Get_assertions_responseContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Get_assertions_responseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_get_assertions_response }
...
impl<'input> Get_assertions_responseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Get_assertions_responseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Get_assertions_responseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Get_assertions_responseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Get_assertions_responseContextExt<'input>>{
...
impl<'input> Get_assertions_responseContextAttrs<'input> for Get_assertions_responseContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn get_assertions_response(&mut self,)
	-> Result<Rc<Get_assertions_responseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Get_assertions_responseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 170, RULE_get_assertions_response);
...
pub type Get_assignment_responseContext<'input> = BaseParserRuleContext<'input,Get_assignment_responseContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Get_assignment_responseContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Get_assignment_responseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_get_assignment_response }
...
impl<'input> Get_assignment_responseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Get_assignment_responseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Get_assignment_responseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Get_assignment_responseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Get_assignment_responseContextExt<'input>>{
...
fn t_valuation_pair_all(&self) ->  Vec<Rc<T_valuation_pairContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn t_valuation_pair(&self, i: usize) -> Option<Rc<T_valuation_pairContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}

}

impl<'input> Get_assignment_responseContextAttrs<'input> for Get_assignment_responseContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn get_assignment_response(&mut self,)
	-> Result<Rc<Get_assignment_responseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Get_assignment_responseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 172, RULE_get_assignment_response);
...
pub type Get_info_responseContext<'input> = BaseParserRuleContext<'input,Get_info_responseContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Get_info_responseContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Get_info_responseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_get_info_response }
...
impl<'input> Get_info_responseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Get_info_responseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Get_info_responseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Get_info_responseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Get_info_responseContextExt<'input>>{
...
fn info_response_all(&self) ->  Vec<Rc<Info_responseContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn info_response(&self, i: usize) -> Option<Rc<Info_responseContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn get_info_response(&mut self,)
	-> Result<Rc<Get_info_responseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Get_info_responseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 174, RULE_get_info_response);
...
pub type Get_model_responseContext<'input> = BaseParserRuleContext<'input,Get_model_responseContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Get_model_responseContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Get_model_responseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_get_model_response }
...
impl<'input> Get_model_responseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Get_model_responseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Get_model_responseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Get_model_responseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Get_model_responseContextExt<'input>>{
...
fn model_response_all(&self) ->  Vec<Rc<Model_responseContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn model_response(&self, i: usize) -> Option<Rc<Model_responseContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn get_model_response(&mut self,)
	-> Result<Rc<Get_model_responseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Get_model_responseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 176, RULE_get_model_response);
...
pub type Get_option_responseContext<'input> = BaseParserRuleContext<'input,Get_option_responseContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Get_option_responseContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Get_option_responseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_get_option_response }
...
impl<'input> Get_option_responseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Get_option_responseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Get_option_responseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Get_option_responseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Get_option_responseContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn get_option_response(&mut self,)
	-> Result<Rc<Get_option_responseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Get_option_responseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 178, RULE_get_option_response);
...
pub type Get_proof_responseContext<'input> = BaseParserRuleContext<'input,Get_proof_responseContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Get_proof_responseContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Get_proof_responseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_get_proof_response }
...
impl<'input> Get_proof_responseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Get_proof_responseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Get_proof_responseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Get_proof_responseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Get_proof_responseContextExt<'input>>{
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn get_proof_response(&mut self,)
	-> Result<Rc<Get_proof_responseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Get_proof_responseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 180, RULE_get_proof_response);
...
pub type Get_unsat_assump_responseContext<'input> = BaseParserRuleContext<'input,Get_unsat_assump_responseContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Get_unsat_assump_responseContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Get_unsat_assump_responseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_get_unsat_assump_response }
...
impl<'input> Get_unsat_assump_responseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Get_unsat_assump_responseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Get_unsat_assump_responseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Get_unsat_assump_responseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Get_unsat_assump_responseContextExt<'input>>{
...
impl<'input> Get_unsat_assump_responseContextAttrs<'input> for Get_unsat_assump_responseContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn get_unsat_assump_response(&mut self,)
	-> Result<Rc<Get_unsat_assump_responseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Get_unsat_assump_responseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 182, RULE_get_unsat_assump_response);
...
pub type Get_unsat_core_responseContext<'input> = BaseParserRuleContext<'input,Get_unsat_core_responseContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Get_unsat_core_responseContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Get_unsat_core_responseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_get_unsat_core_response }
...
impl<'input> Get_unsat_core_responseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Get_unsat_core_responseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Get_unsat_core_responseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Get_unsat_core_responseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Get_unsat_core_responseContextExt<'input>>{
...
impl<'input> Get_unsat_core_responseContextAttrs<'input> for Get_unsat_core_responseContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn get_unsat_core_response(&mut self,)
	-> Result<Rc<Get_unsat_core_responseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Get_unsat_core_responseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 184, RULE_get_unsat_core_response);
...
pub type Get_value_responseContext<'input> = BaseParserRuleContext<'input,Get_value_responseContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Get_value_responseContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Get_value_responseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_get_value_response }
...
impl<'input> Get_value_responseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Get_value_responseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Get_value_responseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Get_value_responseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Get_value_responseContextExt<'input>>{
...
fn valuation_pair_all(&self) ->  Vec<Rc<Valuation_pairContextAll<'input>>> where Self:Sized{
	self.children_of_type()
}
fn valuation_pair(&self, i: usize) -> Option<Rc<Valuation_pairContextAll<'input>>> where Self:Sized{
	self.child_of_type(i)
}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn get_value_response(&mut self,)
	-> Result<Rc<Get_value_responseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Get_value_responseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 186, RULE_get_value_response);
...
pub type Specific_success_responseContext<'input> = BaseParserRuleContext<'input,Specific_success_responseContextExt<'input>>;
...
impl<'input,'a> Listenable<dyn SMTLIBv2Listener<'input> + 'a> for Specific_success_responseContext<'input>{
	fn enter(&self,listener: &mut (dyn SMTLIBv2Listener<'input> + 'a)) {
		listener.enter_every_rule(self);
...
impl<'input> CustomRuleContext<'input> for Specific_success_responseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_specific_success_response }
...
impl<'input> Specific_success_responseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<Specific_success_responseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,Specific_success_responseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait Specific_success_responseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<Specific_success_responseContextExt<'input>>{

fn check_sat_response(&self) -> Option<Rc<Check_sat_responseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn echo_response(&self) -> Option<Rc<Echo_responseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn get_assertions_response(&self) -> Option<Rc<Get_assertions_responseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn get_assignment_response(&self) -> Option<Rc<Get_assignment_responseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn get_info_response(&self) -> Option<Rc<Get_info_responseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn get_model_response(&self) -> Option<Rc<Get_model_responseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn get_option_response(&self) -> Option<Rc<Get_option_responseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn get_proof_response(&self) -> Option<Rc<Get_proof_responseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn get_unsat_assump_response(&self) -> Option<Rc<Get_unsat_assump_responseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn get_unsat_core_response(&self) -> Option<Rc<Get_unsat_core_responseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
fn get_value_response(&self) -> Option<Rc<Get_value_responseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}

}

impl<'input> Specific_success_responseContextAttrs<'input> for Specific_success_responseContext<'input>{}
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn specific_success_response(&mut self,)
	-> Result<Rc<Specific_success_responseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = Specific_success_responseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 188, RULE_specific_success_response);
...
pub type General_responseContext<'input> = BaseParserRuleContext<'input,General_responseContextExt<'input>>;
...
impl<'input> CustomRuleContext<'input> for General_responseContextExt<'input>{
	type TF = LocalTokenFactory<'input>;
	type Ctx = SMTLIBv2ParserContextType;
	fn get_rule_index(&self) -> usize { RULE_general_response }
...
impl<'input> General_responseContextExt<'input>{
	fn new(parent: Option<Rc<dyn SMTLIBv2ParserContext<'input> + 'input > >, invoking_state: isize) -> Rc<General_responseContextAll<'input>> {
		Rc::new(
			BaseParserRuleContext::new_parser_ctx(parent, invoking_state,General_responseContextExt{
				ph:PhantomData
			}),
		)
	}
...
pub trait General_responseContextAttrs<'input>: SMTLIBv2ParserContext<'input> + BorrowMut<General_responseContextExt<'input>>{
...
fn specific_success_response(&self) -> Option<Rc<Specific_success_responseContextAll<'input>>> where Self:Sized{
	self.child_of_type(0)
}
/// Retrieves first TerminalNode corresponding to token PS_Unsupported
/// Returns `None` if there is no child corresponding to token PS_Unsupported
...
where
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	pub fn general_response(&mut self,)
	-> Result<Rc<General_responseContextAll<'input>>,ANTLRError> {
		let mut recog = self;
		let _parentctx = recog.ctx.take();
		let mut _localctx = General_responseContextExt::new(_parentctx.clone(), recog.base.get_state());
        recog.base.enter_rule(_localctx.clone(), 190, RULE_general_response);
		...
		let result: Result<(), ANTLRError> = try {
			...
			,
				3 =>{
					...
					recog.base.match_token(PS_Unsupported,&mut recog.err_handler)?;
